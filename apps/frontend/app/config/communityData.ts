    ...
    projects: [
      {
        ...
        description: 'A collection of reusable React components with accessibility built-in',
      ...
      },
      {
        ...
        description: 'Utilities to simplify testing for JavaScript applications',
    ...
    projects: [
      {
        id: 'project-3',
        name: 'DataNinja',
        description: 'Data preprocessing utilities for machine learning workflows',
