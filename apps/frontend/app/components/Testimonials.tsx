  ...
  return (
    ...
    >
      ...
      <div className="flex items-center relative z-10">
        ...
        <div>
          <h4 className="font-bold transition-colors duration-300 flex items-center" style={{ color: isHovered ? "var(--primary)" : "inherit" }}>
            {author}
            <div className={`ml-2 h-1 w-0 bg-primary rounded-full transition-all duration-300 ${isHovered ? "w-12" : ""}`}></div>
          </h4>
...
export default function Testimonials() {
  ...
  return (
    <section ref={sectionRef} id="testimonials" className="section bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950 py-24">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="w-full max-w-2xl mx-auto p-8 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 relative">
            ...
            <button className="btn-primary hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5">Share Your Story</button>
          </div>
        </div>
      </div>
    </section>
