...
export function WhatsAppIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export function CheckCircleIcon({ className = 'w-10 h-10', ...props }: IconProps) {
  return (
...
export function UserGroupIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function ClipboardListIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function AdjustmentsIcon({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
