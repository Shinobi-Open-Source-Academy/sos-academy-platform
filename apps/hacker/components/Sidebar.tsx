    ...
    <aside className="w-64 min-h-screen bg-[var(--color-surface-1)] border-r border-white/[0.06] flex flex-col">
      ...
      <nav className="flex-1 p-3">
        ...
        <div className="mt-8 pt-6 border-t border-white/[0.06]">
          ...
          <Link
            href="/mentors/book"
            className="flex items-center gap-3 px-3 py-2.5 text-sm text-emerald-400 hover:text-emerald-300 hover:bg-emerald-500/[0.05] transition-all"
          >
            <svg
              className="w-5 h-5"
              fill="none"
        ...
        <div className="p-3 border-t border-white/[0.06]">
          <div className="flex items-center gap-3 p-3 rounded hover:bg-white/[0.02] transition-colors">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-zinc-500 truncate">@{user.githubHandle}</p>
            </div>
            <button
              type="button"
              onClick={handleLogout}
              className="p-1.5 text-zinc-500 hover:text-white hover:bg-white/[0.05] transition-colors"
              title="Sign out"
            >
              <svg
                className="w-4 h-4"
