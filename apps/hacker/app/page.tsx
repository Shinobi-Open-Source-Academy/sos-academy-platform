        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <div className="stat-card animate-fade-in delay-75">
              <p className="text-xs text-zinc-500 uppercase tracking-wider mb-2">PRs This Month</p>
            ...
            <div className="stat-card animate-fade-in delay-150">
              <p className="text-xs text-zinc-500 uppercase tracking-wider mb-2">Events Attended</p>
            ...
            <div className="stat-card animate-fade-in delay-225">
              <p className="text-xs text-zinc-500 uppercase tracking-wider mb-2">Mentor Sessions</p>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="animate-fade-in delay-300">
              ...
              {/* Book Mentor CTA */}
              <div className="mt-6 card p-4 border-emerald-500/20 bg-emerald-500/[0.03]">
                ...
                <Link href="/mentors/book" className="btn-primary text-xs py-2">
                  Book a Session
                </Link>
              </div>
            </div>
